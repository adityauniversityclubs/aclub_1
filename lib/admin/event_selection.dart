...
void addEvent()async{
  DateTime eventDate = DateFormat("yyyy-MM-dd").parse(dateController.text);
  final response=await authService.eventCreation(eventNameController.text, eventDate,guestController.text,locationController.text, 'GDG', mainThemeController.text, detailsController.text);
  _submitDetails();
 
  if(response.containsKey('status')&&response['status']==true){
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content:  Text('Event Successfully created',),backgroundColor: Colors.green,));
  }else{
